...
export default function Method() {
    ...
    const { post, loading, error } = useSinglePostByCategory('method');
    return (
            ...
            <div className="relative w-full max-w-5xl z-10 flex flex-col items-center z-20">
                ...
                <div className="w-full mb-6 text-sm text-gray-600">
                    <div className="flex items-center space-x-2">
                        ...
                        <span>/</span>
                        <span className="text-[#FFC107] font-medium">Phương pháp giáo dục</span>
                    </div>
                </div>
                {/* Logo */}
                <div className="mb-6">
                ...
                <div className="max-w-4xl w-full ">
                    {loading && (
                        <p className="text-center text-gray-600">Đang tải nội dung...</p>
                    )}
