...
export default function EventPage() {
    const { posts, loading, error } = usePostsByCategory("events");
                            ...
                            >
                                ...
                                <div className="relative w-full h-48">
                                    ...
                                    <div className="absolute bottom-0 font-mali-bold">
                                        ...
                                        >
                                            {format(new Date(event.create_at), "dd/MM/yyyy")}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="p-4 flex flex-col flex-1">
                                    ...
                                    <p className="font-mali text-xs text-black line-clamp-3">Đăng bởi: {event.author}</p>
                                    <LineClampContent content={event.content} />
                                </div>
                            </div>
                        ))}
                    </div>
